...
<?php require ("../../../Modelo/FacturaCompra.php")?>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <table id="tabla1" class="table table-bordered table-striped dataTables_scrollBody form-inline">
                        ...
                        <?php
                        $arrfacturacompra = FacturaCompra::getAll();
                        foreach ($arrfacturacompra as $facturacompra){
                            ?>
                            <tr>
                                <td><?php echo $facturacompra->getNFacturaCompra();?></td>
                                <td><?php echo $facturacompra->getFechaCompra(); ?></td>
                                <td><?php echo $facturacompra->getIdProveedor()->getNombreProveedor();?></td>
                                <td><?php echo $facturacompra->getIdPersona()->getNombrePersona();?></td>
                                <td>
                                    <a href="edit.php?id=<?php echo $facturacompra->getIdFacturaCompra(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                    <a href="view.php?id=<?php echo $facturacompra->getIdFacturaCompra(); ?>" type="button" data-toggle="tooltip" title="Ver" class="btn docs-tooltip btn-warning btn-xs"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
