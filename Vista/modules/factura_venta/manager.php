...
<?php require ("../../../Modelo/FacturaVenta.php")?>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <table id="tabla1" class="table table-bordered table-striped dataTables_scrollBody form-inline">
                        ...
                        <?php
                        $arrfacturaventa = FacturaVenta::getAll();
                        foreach ($arrfacturaventa as $facturaventa){
                            ?>
                            <tr>
                                <td><?php echo $facturaventa->getNFacturaVenta();?></td>
                                <td><?php echo $facturaventa->getFechaFactura(); ?></td>
                                <td><?php echo $facturaventa->getIdCliente()->getNombrePersona();?></td>
                                <td><?php echo $facturaventa->getIdVendedor()->getNombrePersona();?></td>
                                <td>
                                    <a href="edit.php?id=<?php echo $facturaventa->getIdFacturaVenta(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                    <a href="view.php?id=<?php echo $facturaventa->getIdFacturaVenta(); ?>" type="button" data-toggle="tooltip" title="Ver" class="btn docs-tooltip btn-warning btn-xs"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
