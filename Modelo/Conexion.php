...
abstract class Conexion {
    ...
    public function __construct(){
        ...
        try {
            ...
            $this->datab->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); //Mostrar errores en las conexiones a BD
            $this->datab->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_ASSOC); //Arrays Asociativos de las tablas
            $this->datab->setAttribute(PDO::ATTR_PERSISTENT, true); //Los datos se almacenan o solo se realizan pruebas
